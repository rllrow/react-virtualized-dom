...
export const DropPositionMonitor = ({ onDropInner, onDropTop, onDropUnder, active }: DropPositionMonitorProps) => {
  return (
    <div
      style={{
        position: 'absolute',
...
const DropPositionMonitorInner = ({ height, onHover }: { height: number; onHover: () => void }) => {
  return (
    <div
      onMouseOver={onHover}
      style={{
